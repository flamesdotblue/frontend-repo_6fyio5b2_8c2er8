...
export default function AuthLogin({ onBack, onSuccess }) {
    ...
    <section className="py-16">
      <div className="mx-auto max-w-md px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-black/5 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur p-6 shadow">
          ...
          <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-300">Log in to continue collaborating.</p>
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button type="submit" className="w-full inline-flex items-center justify-center px-5 py-3 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white font-medium shadow hover:from-blue-500 hover:to-indigo-500 transition">Log in</button>
            <p className="text-center text-sm text-neutral-600 dark:text-neutral-300">New here? <span className="text-blue-600 cursor-pointer" onClick={onBack}>Create an account</span></p>
          </form>
        </div>
      </div>
    </section>
